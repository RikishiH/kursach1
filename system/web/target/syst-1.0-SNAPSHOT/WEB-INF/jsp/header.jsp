        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <security:authorize access="hasRole('ADMIN')">
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/car/add">Добавить машину</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/admin/order">Просмотр заявок</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/order/add">Добавить покупку</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/cars">Просмотр авто</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/order/payed">Просмотр купленных авто</a>
                    </li>
                </security:authorize>

                <security:authorize access="hasRole('USER')">
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/">Просмотр всех авто</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/order/add">Добавить заявку на покупку</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/status">Статус покупки</a>
                    </li>
                </security:authorize>
                ...
                <security:authorize access="hasRole('WORKER')">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/syst/cars">Просмотр всех авто</a>
                    </li>
                    <li class="nav-item">
            ...
            <security:authorize access="isAuthenticated() and hasRole('USER')">
                <%--                    <a class="nav-link" href="${pageContext.request.contextPath}/logout">Logout</a>--%>
                <a class="nav-link" href="/syst/logout">Logout</a>
                <form action="/syst/car/search" class="d-flex">
                    <input name="searchParam" class="form-control me-2" type="search" placeholder="Search"
                           aria-label="Search">
                    <button class="btn btn-outline-success" type="submit">Поиск</button>
                </form>
